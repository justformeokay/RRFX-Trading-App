...
import 'package:rrfx/src/views/accounts/registration_online/views/step_9.dart';
...
class _Step8State extends State<Step8> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ButtonNextPrevious(
          onPressed: () async {
            ...
            bool result = await _regolRepository.step8();
            if(result) {
              Get.to(() => const Step9());
              return;
            }
