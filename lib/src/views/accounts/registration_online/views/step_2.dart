                          ...
                          title: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(regolController.productModels.value?.response[selectedIndex.value].products?[index].name ?? "-", style: GoogleFonts.inter(color: Theme.of(context).brightness == Brightness.dark ? Colors.white : Theme.of(context).textTheme.titleLarge?.color, fontSize: 14, fontWeight: FontWeight.bold)),
                                  Text("Rate: ${regolController.productModels.value?.response[selectedIndex.value].type != null ? regolController.productModels.value!.response[selectedIndex.value].products![index].rate! : "-"}", style: GoogleFonts.inter(color: Theme.of(context).brightness == Brightness.dark ? Colors.white.withOpacity(0.85) : Theme.of(context).textTheme.bodySmall?.color, fontSize: 9)),
                                  Text("Leverage: ${regolController.productModels.value?.response[selectedIndex.value].products != null ? "1:${regolController.productModels.value!.response[selectedIndex.value].products![index].leverage}" : "1:0"}", style: GoogleFonts.inter(color: Theme.of(context).brightness == Brightness.dark ? Colors.white.withOpacity(0.85) : Theme.of(context).textTheme.bodySmall?.color, fontSize: 9)),
                                  Text("Komisi: ${regolController.productModels.value?.response[selectedIndex.value].products != null ? "\$${regolController.productModels.value!.response[selectedIndex.value].products![index].komisi}/lot" : "0"}", style: GoogleFonts.inter(color: Theme.of(context).brightness == Brightness.dark ? Colors.white.withOpacity(0.85) : Theme.of(context).textTheme.bodySmall?.color, fontSize: 9))
                                ],
                              ),
                              Text(regolController.productModels.value?.response[selectedIndex.value].type != null ? regolController.productModels.value!.response[selectedIndex.value].products![index].currency! : "-", style: GoogleFonts.inter(color: Colors.white, fontSize: 12, fontWeight: FontWeight.bold))
                            ],
                          ),
                          value: index + 1,
