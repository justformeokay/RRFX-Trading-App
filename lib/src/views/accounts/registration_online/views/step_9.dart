...
class Step9 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    agreementController.initList(items.length);
        ...
        child: Column(
          children: [
            CustomText.titleHeadingPage(
              context,
              text:
                  "Formulir Dokumen Resiko untuk Transaksi Kontrak Derivatif Dalam Sistem Perdagangan Alternatif.",
            ),
            const Divider(),
            CustomText.titleHeadingPage(
              context,
            ...
            NumberedAgreementList(items: items),
            const SizedBox(height: 10.0),
