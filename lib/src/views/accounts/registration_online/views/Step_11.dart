          ...
          children: [
            Obx(
              () => CustomText.titleHeadingPage(
                context,
                text: stepController.selectedTypeOfCDD.value == "SPA" ? "PERJANJIAN PEMBERIAN AMANAT SECARA ELEKTRONIK ONLINE UNTUK TRANSAKSI KONTRAK DERIVATIF DALAM SISTEM PERDAGANGAN ALTERNATIF" : "PERJANJIAN PEMBERIAN AMANAT SECARA ELEKTRONIK ONLINE UNTUK TRANSAKSI KONTRAK BERJANGKA",
              ),
            ),
            ...
            Obx(
              () => AgreementSectionList(
                sections: {
                  ...
                  stepController.selectedTypeOfCDD.value == "SPA" ? "Pelaksanaan Transaksi" : "Pelaksanaan Amanat": [
                  ...
                  stepController.selectedTypeOfCDD.value == "SPA" ? "Kewajiban Memelihara Margin" : "Antisipasi Penyerahan Barang": [
                  ...
                  stepController.selectedTypeOfCDD.value == "SPA" ? "Pialang Berjangka Dapat Membatasi Posisi" : "Penggantian Kerugian Tidak Menyerahkan Barang": [
