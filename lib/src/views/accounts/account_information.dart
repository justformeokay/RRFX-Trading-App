    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          _infoItem(context, 'CDD Type', selectedAccount?.cddType ?? '-'),
          _infoItem(context, 'Limit Margin', selectedAccount?.limitMargin != null ? NumberFormatter.formatCurrency(selectedAccount!.limitMargin, currency: selectedAccount!.currency!) : '0'),
          _infoItem(context, 'Residual Limit', selectedAccount?.residualLimit != null ? NumberFormatter.formatCurrency(selectedAccount!.residualLimit, currency: selectedAccount!.currency!) : '0'),
