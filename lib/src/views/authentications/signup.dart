...
class _SignupState extends State<Signup> {
  ...
  void updateButtonState() {
    isButtonEnabled.value = !authController.isLoading.value && checkedRead.value && (_formKey.currentState?.validate() ?? false);
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("there!", style: GoogleFonts.inter(fontSize: 50, fontWeight: FontWeight.w700, color: Theme.of(context).textTheme.titleLarge?.color)),
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: GestureDetector(
                                      ...
                                      (index) {
                                        ...
                                        return ListTile(
                                          leading: Container(
                                            ...
                                            child: Center(child: Text("${index + 1}", style: TextStyle(fontSize: 16))),
                                          ),
                                          title: Text(country?.name ?? "", style: TextStyle(fontWeight: FontWeight.w700)),
                                ...
                                child: Container(
                                  ...
                                  child: Text(phoneCode.value, style: const TextStyle(fontWeight: FontWeight.bold)),
                                ),
                              ),
                        ...
                        SizedBox(
                          ...
                          child: Obx(
                            () => DefaultButton.defaultElevatedButton(
                              onPressed: authController.isLoading.value || !checkedRead.value ? null : () {
                                if(_formKey.currentState!.validate() != true) {
                                  return;
                                }
                                if(emailController.text == ""){
                                  return CustomScaffoldMessanger.showAppSnackBar(context, message: "Email tidak boleh kosong", type: SnackBarType.error);
                                }
                                authController.register(
                                  ...
                                  ibCode: referalCode ?? referalController.text,
                                ).then((result) {
                                  if (result) {
